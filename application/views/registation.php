...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href='<?php echo base_url();?>welcome/test'>Logo</a>
    </div>
  ...
  <div class="col-sm-2"></div>
    <div class="col-sm-8">
      <div class="text-center ">
        ...
        <?php  echo form_open('Login_Reg/reg_db');  ?>
          ...
          <div class='form-group'> <!-- Full Name -->
            ...
            <input type='email' class='form-control'   name='email' placeholder='demo@gmail.com' value="<?= set_value('email'); ?>">
            <?php  echo form_error('email');  ?>
          </div> 
          
          <div class='form-group'> <!-- Full Name -->
            <label  class='control-label'>MOBILE NO</label>
            <input type='number' class='form-control'   name='mobile' placeholder='999 999 9999 ' value="<?= set_value('mobile'); ?>">
        ...
        <div class='form-group'> <!-- Full Name -->
           ...
           <select class='form-control' name="branch" >
            <option><?= set_value('branch'); ?></option>
          ...
          <div class='form-group'> <!-- Full Name -->
            ...
            <input type='number' class='form-control'   name='erno' placeholder='Er. No' value="<?= set_value('erno'); ?>">
